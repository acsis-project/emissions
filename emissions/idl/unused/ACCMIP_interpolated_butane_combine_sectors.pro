...
openw, unit1, workspace+'ACCMIP_butane_annual.csv', /get_lun
openw, unit2, workspace+'ACCMIP_butane_monthly.csv', /get_lun
...
for yr=0,n_elements(year)-1 do begin
  ...
  ems_file1  = 'accmip_interpolated_emissions_'+scenario+'_butanes_anthropogenic_'+syear+'_0.5x0.5.nc'
  ems_file2  = 'accmip_interpolated_emissions_'+scenario+'_butanes_biomassburning_'+syear+'_0.5x0.5.nc'
  ems_file3  = 'accmip_interpolated_emissions_'+scenario+'_butanes_ships_'+syear+'_0.5x0.5.nc'
  ems_ofn    = 'accmip_interpolated_emissions_'+scenario+'_butanes_all_sectors_'+syear+'_0.5x0.5.nc'
