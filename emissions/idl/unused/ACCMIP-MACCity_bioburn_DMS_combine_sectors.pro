...
openw, unit, workspace+'MACCity_DMS_bioburn.csv', /get_lun
...
for yr=0,n_elements(year)-1 do begin
  ...
  ems_file1  = 'accmip_maccity_emissions_'+scenario+'_C2H6S_biomassburning_'+syear+'_0.5x0.5.nc'

  ems_ofn    = 'accmip_maccity_emissions_'+scenario+'_DMS_all_sectors_'+syear+'_0.5x0.5.nc'
