...
openw, unit1, workspace+'ACCMIP_bioburn_RCP85_annual_butane.csv', /get_lun
openw, unit2, workspace+'ACCMIP_bioburn_RCP85_monthly_butane.csv', /get_lun
...
; ifp = workspace + 'emissions/other/'
  ...
  ems_file1  = 'accmip_interpolated_emissions_'+scenario+'_butanes_biomassburning_'+syear+'_0.5x0.5.nc'
  ems_ofn    = 'accmip_interpolated_emissions_'+scenario+'_butanes_combined_bioburn_'+syear+'_0.5x0.5.nc'
