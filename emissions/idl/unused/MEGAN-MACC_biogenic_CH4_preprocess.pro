...
;
;
;   MEGAN-MACC_biogenic_CH4_preprocess.pro
;
;
...
ifn = 'MEGAN-MACC_biogenic_CH4_1980-2010_85279.nc'

ofn = 'MEGAN-MACC_biogenic_CH4_processed.nc'
...
openw, unit1, workspace+'/MEGAN-MACC_biogenic_CH4_monthly.csv', /get_lun
openw, unit2, workspace+'/MEGAN-MACC_biogenic_CH4_annual.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Biogenic surface CH4 emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',16.04,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','MEGAN-MACC_biogenic_CH4_preprocess.pro'
