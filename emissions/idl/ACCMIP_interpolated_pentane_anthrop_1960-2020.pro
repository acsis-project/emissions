...
openw, unit1, workspace+'ACCMIP_pentane_RCP85_anthrop_annual.csv', /get_lun
openw, unit2, workspace+'ACCMIP_pentane_RCP85_anthrop_monthly.csv', /get_lun
...
; print
  ...
  for v=0,(numvar_file1+numvar_file3)-1 do begin
  ...
  emstotal = dblarr(numvar_file1+numvar_file3)

  for sector = 0,(numvar_file1+numvar_file3)-1 do begin
