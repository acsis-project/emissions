...
;
;
;   combine_all_sources_BC_fossil_1960-2020.pro
;
;
;   This program reads emissions files for Black Carbon (BC) from 
...
maccity_dir  = 'emissions/ACCMIP-MACCity_anthrop_1960-2020/sectors/BC/'

file1  = ukca_gws + maccity_dir + 'MACCity_anthro_BC_agricultural_production_1960-2020_7195.nc'
file2  = ukca_gws + maccity_dir + 'MACCity_anthro_BC_maritime_transport_1960-2020_7276.nc'
file3  = ukca_gws + maccity_dir + 'MACCity_anthro_BC_solvent_production_and_use_1960-2020_97096.nc'
file4  = ukca_gws + maccity_dir + 'MACCity_anthro_BC_energy_production_and_distribution_1960-2020_96288.nc'
file5  = ukca_gws + maccity_dir + 'MACCity_anthro_BC_land_transport_1960-2020_91634.nc'
file6  = ukca_gws + maccity_dir + 'MACCity_anthro_BC_industrial_processes_and_combustion_1960-2020_3301.nc'


; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_BC_fossil_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_BC_fossil_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/BC_fossil_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/BC_fossil_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface BC fossil fuel emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',12.011,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_BC_fossil_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of Black Carbon (BC) from 1960 to 2020.'
ncdf_attput,ncid,/global,'source','MACCity provides anthropogenic emissions from 1960 to 2020. The emissions flux in this file comprises lumped BC emissions from the following anthropogenic sectors: (1) Agricultural production, (2) maritime transport, (3) solvent production and use, (4) energy production and distribution, (5) land transport, and (6) industrial processes and combustion.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','3.030 Tg C per year'
