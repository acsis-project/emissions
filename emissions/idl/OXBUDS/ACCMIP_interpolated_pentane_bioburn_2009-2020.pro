...
openw, unit1, workspace+'ACCMIP_bioburn_RCP85_annual_pentanes.csv', /get_lun
openw, unit2, workspace+'ACCMIP_bioburn_RCP85_monthly_pentanes.csv', /get_lun
...
; ifp = workspace + 'emissions/other/'
  ...
  ems_file1  = 'accmip_interpolated_emissions_'+scenario+'_pentanes_biomassburning_'+syear+'_0.5x0.5.nc'
  ems_ofn    = 'accmip_interpolated_emissions_'+scenario+'_pentanes_combined_bioburn_'+syear+'_0.5x0.5.nc'
