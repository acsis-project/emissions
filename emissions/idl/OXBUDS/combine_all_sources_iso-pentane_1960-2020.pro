...
;
;
;   combine_all_sources_iso-pentane_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for pentanes from
;
;    * anthropogenic ACCMIP emissions
...
anthrop_file = ukca_gws+'emissions/ACCMIP_interpolated_1850-2100/Pentanes/anthrop_1960-2020_historic_RCP85/newfile.nc'
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/Pentanes/historic/newfile.nc'

; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_iso-pentane_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/OXBUDS/combined_sources_iso-pentane_1960-2020_v3_greg.nc'
...
;allflux = bioburn_flux
;allflux = anthrop_flux
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/iso-pentane_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/iso-pentane_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'history','combine_all_sources_iso-pentane_1960-2020.pro'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','8.33 Tg i-C5H12 per year'
