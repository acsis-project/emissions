...
;
;
;   CMIP6_hybrid_combined_iso-pentane_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for Pentanes from
;
...
anthrop_file = ukca_gws+'emissions/CMIP6/anthrop/CMIP6_CEDS+RCP85_anthropogenic_pentanes_1960-2020.nc'
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/Pentanes/historic/newfile.nc'

; output file:

ofn          = ukca_gws+'emissions/OXBUDS/CMIP6_hybrid_combined_iso-pentane_1960-2020_v1_greg.nc'
...
part_factor  = 0.57   ; Helmig et al. 2014
...
; partitioning of isomers:

allflux = allflux * part_factor
...
openw, unit1, ukca_gws+'emissions/OXBUDS/CMIP6_hybrid_iso-pentane_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/OXBUDS/CMIP6_hybrid_iso-pentane_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface i-C5H12 emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',72.15,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'
ncdf_attput,ncid,fieldvar_id,'pentanes_fraction',part_factor,/float
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_hybrid_combined_iso-pentane_1960-2020.pro v1.0'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of iso-pentane from 1960 to 2020.'
ncdf_attput,ncid,/global,'source','The emissions flux in this file comprises combined emissions from anthropogenic and biomass burning. CEDS provides anthropogenic emissions from 1960 to 2014. MACCity provides biomass burning emissions from 1960 to 2008. Anthropogenic emissions from 2015 to 2020 and biomass burning emissions from 2009 to 2020 have been taken from the ACCMIP linearly interpolated RCP8.5 data set.'
ncdf_attput,ncid,/global,'partitioning','iso-pentane is 57% of all pentanes'
ncdf_attput,ncid,/global,'reference','Hoesly et al., Geosci. Mod. Dev., 2018; Lamarque et al., Atmos. Chem. Phys., 2010; Granier et al., Clim. Change, 2011;  Helmig et al., Atmos. Environ., 2014.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','10.84 Tg i-C5H12 per year'
