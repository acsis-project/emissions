...
anthrop_file = ukca_gws+'emissions/CMIP6/anthrop/v2/CMIP6_CEDS_anthropogenic_pentanes_1960-2020_v2.nc'
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/Pentanes/historic/newfile.nc'

; output file:

ofn          = ukca_gws+'emissions/OXBUDS/CMIP6_hybrid_combined_iso-pentane_1960-2020_v2_greg.nc'
...
openw, unit1, ukca_gws+'emissions/OXBUDS/CMIP6_hybrid_iso-pentane_monthly_combined_v2.csv', /get_lun
openw, unit2, ukca_gws+'emissions/OXBUDS/CMIP6_hybrid_iso-pentane_annual_combined_v2.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_hybrid_combined_iso-pentane_1960-2020.pro v2.0'
