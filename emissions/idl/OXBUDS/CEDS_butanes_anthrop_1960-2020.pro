...
;   Date:     Mon Apr 16 15:34:09 BST 2018
;   version:  2.0
;
;
;-----------------------------------------------------------------------------
...
ofname    = 'CMIP6_CEDS_anthropogenic_butanes_1960-2020_v2.nc'
...
openw, unit1, workspace+'CEDS_butanes_anthrop_annual.csv', /get_lun
openw, unit2, workspace+'CEDS_butanes_anthrop_monthly.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CEDS_butanes_anthrop_1960-2020.pro v2.0'
