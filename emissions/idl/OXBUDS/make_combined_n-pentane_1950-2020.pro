...
;
;
;   make_combined_n-pentane_1950-2020.pro
;
;
...
; input file:
ifn   = gws+'emissions/OXBUDS/0.5x0.5/v3/combined_sources_n-pentane_1960-2020_v3_greg.nc'
; output file:
ofn   = gws+'emissions/OXBUDS/0.5x0.5/v4/combined_sources_n-pentane_1950-2020_v4.nc'
...
ncdf_attput,ncid,/global,'history','make_combined_n-pentane_1950-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of n-pentane from 1950 to 2020.'
