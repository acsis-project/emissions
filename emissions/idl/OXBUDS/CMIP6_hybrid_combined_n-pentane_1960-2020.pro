...
;
;
;   CMIP6_hybrid_combined_n-pentane_1960-2020.pro
;
;
...
ofn          = ukca_gws+'emissions/OXBUDS/CMIP6_hybrid_combined_n-pentane_1960-2020_v1_greg.nc'
...
part_factor  = 0.43   ; Helmig et al. 2014
...
openw, unit1, ukca_gws+'emissions/OXBUDS/CMIP6_hybrid_n-pentane_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/OXBUDS/CMIP6_hybrid_n-pentane_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface n-C5H12 emissions'
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_hybrid_combined_n-pentane_1960-2020.pro v1.0'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of n-pentane from 1960 to 2020.'
...
ncdf_attput,ncid,/global,'partitioning','n-pentane is 43% of all pentanes'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','8.17 Tg n-C5H12 per year'
