...
openw, unit1, workspace+'ACCMIP_pentane_annual.csv', /get_lun
openw, unit2, workspace+'ACCMIP_pentane_monthly.csv', /get_lun
...
for yr=0,n_elements(year)-1 do begin
  ...
  ems_file1  = 'accmip_interpolated_emissions_'+scenario+'_pentanes_anthropogenic_'+syear+'_0.5x0.5.nc'
  ems_file2  = 'accmip_interpolated_emissions_'+scenario+'_pentanes_biomassburning_'+syear+'_0.5x0.5.nc'
  ems_file3  = 'accmip_interpolated_emissions_'+scenario+'_pentanes_ships_'+syear+'_0.5x0.5.nc'
  ems_ofn    = 'accmip_interpolated_emissions_'+scenario+'_pentanes_all_sectors_'+syear+'_0.5x0.5.nc'
  ...
  for t = 0,n_elements(times)-1 do begin
     monthtotal = total(emsfield[*,*,t,0]*surf[*,*]*double(numdays[t])*secs_per_day,/double) $
                ...
                + total(emsfield[*,*,t,8]*surf[*,*]*double(numdays[t])*secs_per_day,/double) $
