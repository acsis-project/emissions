...
;
;
;   combine_all_sources_iso-butane_1960-2020.pro
;
;
...
;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_iso-butane_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/OXBUDS/combined_sources_iso-butane_1960-2020_v3_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/iso-butane_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/iso-butane_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'history','combine_all_sources_iso-butane_1960-2020.pro'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','3.69 Tg i-C4H10 per year'
