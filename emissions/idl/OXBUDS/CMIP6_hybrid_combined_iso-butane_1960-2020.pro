...
;
;
;   CMIP6_hybrid_combined_iso-butane_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for Butanes from
;
...
anthrop_file = ukca_gws+'emissions/CMIP6/anthrop/CMIP6_CEDS+RCP85_anthropogenic_butanes_1960-2020.nc'
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/Butanes/historic/newfile.nc'

; output file:

ofn          = ukca_gws+'emissions/OXBUDS/CMIP6_hybrid_combined_iso-butane_1960-2020_v1_greg.nc'
...
part_factor  = 0.35   ; Helmig et al. 2014
...
openw, unit1, ukca_gws+'emissions/OXBUDS/CMIP6_hybrid_iso-butane_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/OXBUDS/CMIP6_hybrid_iso-butane_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface i-C4H10 emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',58.12,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'
ncdf_attput,ncid,fieldvar_id,'butanes_fraction',part_factor,/float
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_hybrid_combined_iso-butane_1960-2020.pro v1.0'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of iso-butane from 1960 to 2020.'
...
ncdf_attput,ncid,/global,'partitioning','iso-butane is 35% of all butanes'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','5.38 Tg i-C4H10 per year'
