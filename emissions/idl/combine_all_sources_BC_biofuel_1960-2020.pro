...
;
;
;   combine_all_sources_BC_biofuel_1960-2020.pro
;
;
...
file1  = ukca_gws + maccity_dir + 'MACCity_anthro_BC_residential_and_commercial_combustion_1960-2020_6492.nc'
file2  = ukca_gws + maccity_dir + 'MACCity_anthro_BC_agricultural_waste_burning_1960-2020_6556.nc'
file3  = ukca_gws + maccity_dir + 'MACCity_anthro_BC_waste_treatment_and_disposal_1960-2020_3165.nc'


; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_BC_biofuel_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_BC_biofuel_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/BC_biofuel_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/BC_biofuel_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface BC biofuel emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',12.011,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_BC_biofuel_1960-2020.pro'
...
ncdf_attput,ncid,/global,'source','MACCity provides anthropogenic emissions from 1960 to 2020. The emissions flux in this file comprises lumped BC emissions from the following anthropogenic sectors: (1) Residential and commercial combustion, (2) agricultural waste burning, and (3) waste treatment and disposal.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','2.132 Tg C per year'
