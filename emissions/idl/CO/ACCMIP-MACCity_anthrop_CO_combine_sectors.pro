...
file = 'MACCity_anthro_CO_1960-2020_12697.nc'
...
openw, unit1, workspace+'MACCity_anthrop_monthly.csv', /get_lun
openw, unit2, workspace+'MACCity_anthrop_annual.csv', /get_lun
