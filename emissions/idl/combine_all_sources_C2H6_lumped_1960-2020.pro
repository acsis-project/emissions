...
;
;
;   combine_all_sources_C2H6_lumped_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for propane and propene 
;   from all sectors and combines all the data into one netCDF file using one 
;   joint lumped emissions mass flux for the emitted specie.
;
...
; processed data input files:

; all files have the same dimensions in lons, lats and times, 

ukca_gws     = '/group_workspaces/jasmin2/ukca/vol1/mkoehler/'

;file1 = ukca_gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_C2H6_1960-2020_greg.nc'
;file2 = ukca_gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_ethene_1960-2020_greg.nc'
;file3 = ukca_gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_ethyne_1960-2020_greg.nc'
file1 = ukca_gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_C2H6_1960-2020_360d.nc'
file2 = ukca_gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_ethene_1960-2020_360d.nc'
file3 = ukca_gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_ethyne_1960-2020_360d.nc'

; output file:

ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_C2H6_lumped_1960-2020_360d.nc'
;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_C2H6_lumped_1960-2020_greg.nc'
gregorian    = 0  ; set to 1 for Gregorian or 0 for 360-day calendar

; scaling factors for lumping of emissions:

molw_C2H6 = 30.07d
molw_ethene = 28.05d
molw_ethyne = 26.04d

scale2 = molw_C2H6/molw_ethene
scale3 = molw_C2H6/molw_ethyne
...
;---- open first emissions file

print
print,'reading first input file'
...
ncdf_varget,ncid,varid,flux1
ncdf_close,ncid


;---- open second emissions file

print,'reading second input file'

ncid = ncdf_open(file2,/nowrite)
varid  = ncdf_varid(ncid,'emiss_flux')
ncdf_varget,ncid,varid,flux2
ncdf_close,ncid
...
;---- open third emissions file

print,'reading third input file'

ncid = ncdf_open(file3,/nowrite)
varid  = ncdf_varid(ncid,'emiss_flux')
ncdf_varget,ncid,varid,flux3
ncdf_close,ncid
...
;---- add fluxes to lumped emissions

print,'lumping all fluxes'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/C2H6_lumped_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/C2H6_lumped_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','57.868 Tg C2H6 per year'
