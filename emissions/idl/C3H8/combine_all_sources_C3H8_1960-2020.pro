...
;
;
;   combine_all_sources_C3H8_1960-2020.pro
;
;
...
anthrop_file = ukca_gws+'emissions/ACCMIP-MACCity_anthrop_1960-2020/C3H8/newfile.nc'
...
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_C3H8_1960-2020_360d.nc'
;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_C3H8_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/C3H8_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/C3H8_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'history','combine_all_sources_C3H8_1960-2020.pro'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','6.419 Tg C3H8 per year'
