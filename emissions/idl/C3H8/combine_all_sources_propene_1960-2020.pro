...
;
;
;   combine_all_sources_propene_1960-2020.pro
;
;
...
anthrop_file = ukca_gws+'emissions/ACCMIP-MACCity_anthrop_1960-2020/propene/newfile.nc'
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/propene/historic/newfile.nc'
biogen_file  = ukca_gws+'emissions/MEGAN-MACC_1980-2010/MEGAN-MACC_biogenic_propene_processed.nc'
oceanic_file = ukca_gws+'emissions/POET_1990/POET_oceanic_propene_1990_processed.nc'

; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_propene_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_propene_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/Propene_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/Propene_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface propene emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',42.08,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_propene_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of propene (propylene, C3H6) from 1960 to 2020.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','22.496 Tg C3H6 per year'
