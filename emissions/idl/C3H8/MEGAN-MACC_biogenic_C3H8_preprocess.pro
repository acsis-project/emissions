...
;
;
;   MEGAN-MACC_biogenic_C3H8_preprocess.pro
;
;
...
ifn = 'MEGAN-MACC_biogenic_propane_1980-2010_85950.nc'

ofn = 'MEGAN-MACC_biogenic_C3H8_processed.nc'
...
openw, unit1, workspace+'/MEGAN-MACC_biogenic_C3H8_monthly.csv', /get_lun
openw, unit2, workspace+'/MEGAN-MACC_biogenic_C3H8_annual.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Biogenic surface C3H8 emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',44.10,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','MEGAN-MACC_biogenic_C3H8_preprocess.pro'
