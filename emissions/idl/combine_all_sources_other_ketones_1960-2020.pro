...
;
;
;   combine_all_sources_other_ketones_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for propene from
;
...
anthrop_file = ukca_gws+'emissions/ACCMIP-MACCity_anthrop_1960-2020/other_ketones/newfile.nc'
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/other_ketones/historic/newfile.nc'
biogen_file  = ukca_gws+'emissions/MEGAN-MACC_1980-2010/MEGAN-MACC_biogenic_other_ketones_processed.nc'

; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_non-acetone-ketones_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_non-acetone-ketones_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/other_ketones_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/other_ketones_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface emissions of non-acetone ketones'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',58.08,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_other_ketones_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of lumped non-acetone ketones, including 2-butanone (C4H8O), pentanones(C5H10O), heptanones(C7H12O), and octanones (C8H16O), expressed as acetone flux from 1960 to 2020.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','2.516 Tg Me2CO per year'
