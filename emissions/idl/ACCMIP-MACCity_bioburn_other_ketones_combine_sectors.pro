...
molw_Me2CO=58.08d
molw_oKet=102.25d  ; from input file meta data
...
openw, unit, workspace+'MACCity_other_ketones_bioburn.csv', /get_lun
...
for yr=0,n_elements(year)-1 do begin
  ...
  ems_file1  = 'accmip_maccity_emissions_'+scenario+'_non-acetone-ketones_biomassburning_'+syear+'_0.5x0.5.nc'
;  ems_file2  = 'accmip_interpolated_emissions_'+scenario+'_non-acetone-ketones_biomassburning_'+syear+'_0.5x0.5.nc'
;  ems_file3  = 'accmip_interpolated_emissions_'+scenario+'_non-acetone-ketones_ships_'+syear+'_0.5x0.5.nc'

  ems_ofn    = 'accmip_maccity_emissions_'+scenario+'_non-acetone-ketones_all_sectors_'+syear+'_0.5x0.5.nc'
