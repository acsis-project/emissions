...
;
;
;   MEGAN-MACC_biogenic_ethanol_preprocess.pro
;
;
...
ifn = 'MEGAN-MACC_biogenic_ethanol_1980-2010_40764.nc'

ofn = 'MEGAN-MACC_biogenic_ethanol_processed.nc'
...
openw, unit1, workspace+'/MEGAN-MACC_biogenic_ethanol_monthly.csv', /get_lun
openw, unit2, workspace+'/MEGAN-MACC_biogenic_ethanol_annual.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Biogenic surface ethanol (C2H6O) emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',46.07,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','MEGAN-MACC_biogenic_ethanol_preprocess.pro'
