...
;
;
;   MEGAN-MACC_biogenic_C2H6_preprocess.pro
;
;
...
ifn = 'MEGAN-MACC_biogenic_ethane_1980-2010_85930.nc'

ofn = 'MEGAN-MACC_biogenic_C2H6_processed.nc'
...
openw, unit1, workspace+'/MEGAN-MACC_biogenic_C2H6_monthly.csv', /get_lun
openw, unit2, workspace+'/MEGAN-MACC_biogenic_C2H6_annual.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Biogenic surface C2H6 emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',30.07,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','MEGAN-MACC_biogenic_C2H6_preprocess.pro'
