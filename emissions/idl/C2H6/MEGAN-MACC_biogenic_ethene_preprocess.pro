...
;
;
;   MEGAN-MACC_biogenic_ethene_preprocess.pro
;
;
...
ifn = 'MEGAN-MACC_biogenic_ethene_1980-2010_97952.nc'

ofn = 'MEGAN-MACC_biogenic_ethene_processed.nc'
...
openw, unit1, workspace+'/MEGAN-MACC_biogenic_ethene_monthly.csv', /get_lun
openw, unit2, workspace+'/MEGAN-MACC_biogenic_ethene_annual.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Biogenic surface ethene (ethylene, C2H4) emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',28.05,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','MEGAN-MACC_biogenic_ethene_preprocess.pro'
