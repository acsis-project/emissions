...
anthrop_file = ukca_gws+'emissions/ACCMIP-MACCity_anthrop_1960-2020/CH3OH/newfile.nc'
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/CH3OH/historic/newfile.nc'
biogen_file  = ukca_gws+'emissions/MEGAN-MACC_1980-2010/MEGAN-MACC_biogenic_CH3OH_processed.nc'

; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_CH3OH_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_CH3OH_1960-2020_greg.nc'
...
; scaling factor CH3OHtoC

molw_CH3OH=double(32.04)
molw_carbon=double(12.011)

CH3OHtoC = molw_carbon/molw_CH3OH
...
;---- convert flux from CH3OH to Carbon

allflux = allflux * CH3OHtoC   ; flux now expressed as kg[C] m-2 s-1
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/CH3OH_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/CH3OH_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'history','combine_all_sources_CH3OH_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of methanol (CH3OH) from 1960 to 2020, expressed as carbon.'
