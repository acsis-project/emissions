...
file = 'MACCity_anthro_methanol_1960-2020_4015.nc'
...
openw, unit1, workspace+'MACCity_anthrop_CH3OH_monthly.csv', /get_lun
openw, unit2, workspace+'MACCity_anthrop_CH3OH_annual.csv', /get_lun
...
for yr=0,numyears-1 do begin
  ...
  ems_ofn    = 'accmip_maccity_emissions_anthrop_CH3OH_all_sectors_'+syear+'_0.5x0.5.nc'
