...
file = 'MACCity_anthro_formaldehyde_1960-2020_15023.nc'
...
openw, unit1, workspace+'MACCity_anthrop_HCHO_monthly.csv', /get_lun
openw, unit2, workspace+'MACCity_anthrop_HCHO_annual.csv', /get_lun
...
for yr=0,numyears-1 do begin
  ...
  ems_ofn    = 'accmip_maccity_emissions_anthrop_HCHO_all_sectors_'+syear+'_0.5x0.5.nc'
