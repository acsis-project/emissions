...
;
;
;   make_combined_HCHO_1950-2020.pro
;
;
...
; input file:
ifn   = gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_HCHO_1960-2020_greg.nc'
; output file:
ofn   = gws+'emissions/combined_1950-2020/combined_sources_HCHO_1950-2020.nc'
...
ncdf_attput,ncid,/global,'history','make_combined_HCHO_1950-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of formaldehyde from 1950 to 2020.'
