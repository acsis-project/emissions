...
;
;
;   combine_all_sources_HCHO_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for HCHO from
;
...
anthrop_file = ukca_gws+'emissions/ACCMIP-MACCity_anthrop_1960-2020/HCHO/newfile.nc'
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/HCHO/historic/newfile.nc'
biogen_file  = ukca_gws+'emissions/MEGAN-MACC_1980-2010/MEGAN-MACC_biogenic_HCHO_processed.nc'

; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_HCHO_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_HCHO_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/HCHO_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/HCHO_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface HCHO emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',30.03,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_HCHO_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of formaldehyde from 1960 to 2020.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','12.179 Tg HCHO per year'
