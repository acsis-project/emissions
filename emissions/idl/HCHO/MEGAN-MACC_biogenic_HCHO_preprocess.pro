...
;
;
;   MEGAN-MACC_biogenic_HCHO_preprocess.pro
;
;
...
ifn = 'MEGAN-MACC_biogenic_formaldehyde_1980-2010_86024.nc'

ofn = 'MEGAN-MACC_biogenic_HCHO_processed.nc'
...
openw, unit1, workspace+'/MEGAN-MACC_biogenic_HCHO_monthly.csv', /get_lun
openw, unit2, workspace+'/MEGAN-MACC_biogenic_HCHO_annual.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Biogenic surface HCHO emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',30.03,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','MEGAN-MACC_biogenic_HCHO_preprocess.pro'
