...
;
;
;   combine_all_sources_ethyne_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for ethyne from
;
;    * anthropogenic ACCMIP (linearly interpolated) emissions
...
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/ethyne/historic/newfile.nc'
anthrop_file = ukca_gws+'emissions/ACCMIP_interpolated_1850-2100/ethyne/historic_all_sectors_1960-2000/newfile.nc'

; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_ethyne_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_ethyne_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/Ethyne_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/Ethyne_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface ethyne emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',26.04,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_ethyne_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of ethyne (acetylene, C2H2) from 1960 to 2020.'
ncdf_attput,ncid,/global,'source','The emissions flux in this file comprises combined emissions from anthropogenic and biomass burning sources. The ACCMIP linearly interpolated data set provides anthropogenic emissions from 1960 to 2020 (historic until 2000, then RCP85) and MACCity provides biomass burning emissions from 1960 to 2008. Biomass burning emissions from 2009 to 2020 have been taken from the ACCMIP linearly interpolated RCP8.5 data set.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','4.554 Tg C2H2 per year'
