...
;
;
;   combine_all_sources_C5H8_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for isoprene from
;
...
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/C5H8/historic/newfile.nc'
biogen_file  = ukca_gws+'emissions/MEGAN-MACC_1980-2010/MEGAN-MACC_biogenic_C5H8_processed.nc'

; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_C5H8_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_C5H8_1960-2020_greg.nc'
...
; however times have the wrong units, hence they are read from biogenic file
print 
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/C5H8_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/C5H8_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','573.88 Tg C5H8 per year'
