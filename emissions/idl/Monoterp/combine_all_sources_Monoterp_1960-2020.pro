...
;
;
;   combine_all_sources_Monoterp_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for monoterpene from
;
...
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/Monoterp/historic/newfile.nc'
biogen_file  = ukca_gws+'emissions/MEGAN-MACC_1980-2010/MEGAN-MACC_biogenic_monoterp_processed.nc'

; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_Monoterp_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_Monoterp_1960-2020_greg.nc'
...
allflux = bioburn_flux + biogen_flux
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/Monoterp_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/Monoterp_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','94.94 Tg Monoterpene per year'
