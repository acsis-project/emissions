...
;
;
;   MEGAN-MACC_biogenic_MeCHO_preprocess.pro
;
;
...
ifn = 'MEGAN-MACC_biogenic_acetaldehyde_1980-2010_86083.nc'

ofn = 'MEGAN-MACC_biogenic_MeCHO_processed.nc'
...
openw, unit1, workspace+'/MEGAN-MACC_biogenic_MeCHO_monthly.csv', /get_lun
openw, unit2, workspace+'/MEGAN-MACC_biogenic_MeCHO_annual.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Biogenic surface acetaldehyde (C2H4O) emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',44.05,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','MEGAN-MACC_biogenic_MeCHO_preprocess.pro'
