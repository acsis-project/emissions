...
openw, unit1, workspace+'ACCMIP_annual_MeCHO.csv', /get_lun
openw, unit2, workspace+'ACCMIP_bioburn_monthly_MeCHO.csv', /get_lun
...
for yr=0,n_elements(year)-1 do begin
  ...
  ems_file1  = 'accmip_interpolated_emissions_'+scenario+'_other-alkanals_biomassburning_'+syear+'_0.5x0.5.nc'
  ems_ofn    = 'accmip_interpolated_emissions_'+scenario+'_MeCHO_combined_bioburn_'+syear+'_0.5x0.5.nc'
  ...
  ; add all biomass burning sectors (for MeCHO that's 0-1)
