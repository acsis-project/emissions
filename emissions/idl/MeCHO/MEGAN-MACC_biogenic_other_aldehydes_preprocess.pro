...
;
;
;   MEGAN-MACC_biogenic_other_aldehydes_preprocess.pro
;
;
...
ifn = 'MEGAN-MACC_biogenic_other_aldehydes_1980-2010_7641.nc'

ofn = 'MEGAN-MACC_biogenic_other_aldehydes_processed.nc'
...
openw, unit1, workspace+'/MEGAN-MACC_biogenic_other_aldehydes_monthly.csv', /get_lun
openw, unit2, workspace+'/MEGAN-MACC_biogenic_other_aldehydes_annual.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Biogenic surface emissions of lumped non-CH2O aldehydes, expressed as acetaldehyde (ethanal, MeCHO)'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',44.05,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','MEGAN-MACC_biogenic_other_aldehydes_preprocess.pro'
