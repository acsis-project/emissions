...
anthrop_dir = workspace+'emissions/ACCMIP-MACCity_anthrop_1960-2020/MeCHO/'
bioburn_dir = workspace+'emissions/ACCMIP-MACCity_bioburn_1960-2008/MeCHO/historic/'

ofn = workspace+'emissions/ACCMIP-MACCity_MeCHO_combined.nc'
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface acetaldehyde (C2H4O) emissions from all sectors (anthrop+bioburn)'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',44.05,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','ACCMIP-MACCity_combine_all_MeCHO_1960-2020.pro'
