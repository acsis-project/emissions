...
anthrop_dir = workspace+'emissions/ACCMIP-MACCity_anthrop_1960-2020/NH3/'
bioburn_dir = workspace+'emissions/ACCMIP-MACCity_bioburn_1960-2008/NH3/historic/'

ofn = workspace+'emissions/ACCMIP-MACCity_NH3_combined.nc'
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface NH3 emissions from all sectors (anthrop+bioburn)'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',17.031,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','ACCMIP-MACCity_combine_all_NH3_1960-2020.pro'
