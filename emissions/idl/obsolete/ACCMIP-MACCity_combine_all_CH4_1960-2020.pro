...
anthrop_dir = workspace+'emissions/ACCMIP_interpolated_1850-2100/CH4/anthropogenic_all_sectors_1950-2020/'
bioburn_dir = workspace+'emissions/ACCMIP-MACCity_bioburn_1960-2008/CH4/historic/'

ofn = workspace+'emissions/ACCMIP-MACCity_CH4_combined.nc'
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface CH4 emissions from all sectors (anthrop+bioburn)'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',16.04,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','ACCMIP-MACCity_combine_all_CH4_1960-2020.pro'
ncdf_attput,ncid,/global,'source','Time-varying monthly CH4 emissions from 1960 to 2020 from the ACCMIP and MACCity data sets. Anthropogenic emissions come from the ACCMIP linearly interpolated data, using historic data from 1960 to 2000 and RCP8.5 from 2001 to 2020. MACCity provides historic biomass burning emissions data from 1960 to 2008. Biomass burning emissions from 2009 to 2020 have been taken from the ACCMIP linearly interpolated RCP8.5 data set.'
