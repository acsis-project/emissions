...
anthrop_dir = workspace+'emissions/ACCMIP-MACCity_anthrop_1960-2020/C3H8/'
bioburn_dir = workspace+'emissions/ACCMIP-MACCity_bioburn_1960-2008/C3H8/historic/'

ofn = workspace+'emissions/ACCMIP-MACCity_C3H8_combined.nc'
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface C3H8 emissions from all sectors (anthrop+bioburn)'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',44.10,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','ACCMIP-MACCity_combine_all_C3H8_1960-2020.pro'
