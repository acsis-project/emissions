...
anthrop_dir = workspace+'emissions/ACCMIP-MACCity_anthrop_1960-2020/HCHO/'
bioburn_dir = workspace+'emissions/ACCMIP-MACCity_bioburn_1960-2008/HCHO/historic/'

ofn = workspace+'emissions/ACCMIP-MACCity_HCHO_combined.nc'
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface HCHO emissions from all sectors (anthrop+bioburn)'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',30.03,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','ACCMIP-MACCity_combine_all_HCHO_1960-2020.pro'
