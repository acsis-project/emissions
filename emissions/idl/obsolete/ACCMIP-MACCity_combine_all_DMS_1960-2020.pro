...
bioburn_dir = workspace+'emissions/ACCMIP-MACCity_bioburn_1960-2008/DMS/historic/'

ofn = workspace+'emissions/ACCMIP-MACCity_DMS_combined.nc'
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface DMS (C2H6S) emissions from biomass burning sectors'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',62.14,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','ACCMIP-MACCity_combine_all_DMS_1960-2020.pro'
ncdf_attput,ncid,/global,'source','Time-varying monthly emissions from 1960 to 2020 from the MACCity data set. MACCity provides biomass burning emissions from 1960 to 2008. Biomass burning emissions from 2009 to 2020 have been taken from the ACCMIP linearly interpolated RCP8.5 data set. There are no anthropogenic DMS emissions in this data set.'
