...
anthrop_dir = workspace+'emissions/ACCMIP-MACCity_anthrop_1960-2020/C2H6/'
bioburn_dir = workspace+'emissions/ACCMIP-MACCity_bioburn_1960-2008/C2H6/historic/'

ofn = workspace+'emissions/ACCMIP-MACCity_C2H6_combined.nc'
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface C2H6 emissions from all sectors (anthrop+bioburn)'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',30.07,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','ACCMIP-MACCity_combine_all_C2H6_1960-2020.pro'
