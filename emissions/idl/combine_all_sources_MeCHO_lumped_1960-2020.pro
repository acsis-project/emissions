...
;
;
;   combine_all_sources_MeCHO_lumped_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for acetaldehyde and other 
;   aldehydes from all sectors and combines all the data into one netCDF file using
;   one joint lumped emissions mass flux for the emitted specie.
;
...
anthrop_file = ukca_gws+'emissions/ACCMIP-MACCity_anthrop_1960-2020/MeCHO/newfile.nc'
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/MeCHO/historic/newfile.nc'
biogen_file1 = ukca_gws+'emissions/MEGAN-MACC_1980-2010/MEGAN-MACC_biogenic_MeCHO_processed.nc'
biogen_file2 = ukca_gws+'emissions/MEGAN-MACC_1980-2010/MEGAN-MACC_biogenic_other_aldehydes_processed.nc'

; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_MeCHO_lumped_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_MeCHO_lumped_1960-2020_greg.nc'
...
print,'reading second biogenic emissions file'
...
allflux = anthrop_flux + bioburn_flux + biogen_flux1 + biogen_flux2
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/MeCHO_lumped_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/MeCHO_lumped_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface MeCHO emissions'
ncdf_attput,ncid,fieldvar_id,'lumping','Lumped emissions of acetaldehyde and other non-CH2O-aldehydes, expressed as MeCHO'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',44.05,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_MeCHO_lumped_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of acetaldehyde lumped with other non-CH2O from 1960 to 2020.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','25.721 Tg MeCHO per year'
