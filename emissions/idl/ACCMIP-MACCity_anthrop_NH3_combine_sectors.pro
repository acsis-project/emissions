...
file = 'MACCity_anthro_NH3_1960-2020_98238.nc'
...
openw, unit1, workspace+'MACCity_anthrop_NH3_monthly.csv', /get_lun
openw, unit2, workspace+'MACCity_anthrop_NH3_annual.csv', /get_lun
