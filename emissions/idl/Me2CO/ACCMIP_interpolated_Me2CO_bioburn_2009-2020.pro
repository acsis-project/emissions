...
openw, unit1, workspace+'ACCMIP_annual_Me2CO.csv', /get_lun
openw, unit2, workspace+'ACCMIP_bioburn_monthly_Me2CO.csv', /get_lun
...
for yr=0,n_elements(year)-1 do begin
  ...
  ems_file1  = 'accmip_interpolated_emissions_'+scenario+'_C3H6O_biomassburning_'+syear+'_0.5x0.5.nc'
  ems_ofn    = 'accmip_interpolated_emissions_'+scenario+'_Me2CO_combined_bioburn_'+syear+'_0.5x0.5.nc'
