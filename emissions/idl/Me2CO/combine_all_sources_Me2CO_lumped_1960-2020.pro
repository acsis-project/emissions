...
;
;
;   combine_all_sources_Me2CO_lumped_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for acetone and other ketones
...
;file1 = ukca_gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_Me2CO_1960-2020_greg.nc'
;file2 = ukca_gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_non-acetone-ketones_1960-2020_greg.nc'
file1 = ukca_gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_Me2CO_1960-2020_360d.nc'
file2 = ukca_gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_non-acetone-ketones_1960-2020_360d.nc'

; output file:

ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_Me2CO_lumped_1960-2020_360d.nc'
;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_Me2CO_lumped_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/Me2CO_lumped_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/Me2CO_lumped_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface Me2CO emissions'
ncdf_attput,ncid,fieldvar_id,'lumping','Lumped emissions of acetone and other ketones, expressed as Me2CO'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',58.08,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_Me2CO_lumped_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of acetone lumped with other ketones from 1960 to 2020.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','42.962 Tg Me2CO per year'
