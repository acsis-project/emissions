...
;
;
;   MEGAN-MACC_biogenic_Me2CO_preprocess.pro
;
;
...
ifn = 'MEGAN-MACC_biogenic_acetone_1980-2010_86117.nc'

ofn = 'MEGAN-MACC_biogenic_Me2CO_processed.nc'
...
openw, unit1, workspace+'/MEGAN-MACC_biogenic_Me2CO_monthly.csv', /get_lun
openw, unit2, workspace+'/MEGAN-MACC_biogenic_Me2CO_annual.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Biogenic surface acetone (C3H6O) emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',58.08,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','MEGAN-MACC_biogenic_Me2CO_preprocess.pro'
