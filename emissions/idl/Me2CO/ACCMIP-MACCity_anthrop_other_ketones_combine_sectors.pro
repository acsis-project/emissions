...
file = 'MACCity_anthro_other_ketones_1960-2020_4048.nc'
...
openw, unit1, workspace+'MACCity_anthrop_other_ketones_monthly.csv', /get_lun
openw, unit2, workspace+'MACCity_anthrop_other_ketones_annual.csv', /get_lun
...
;---- scale from lumped species to target species flux -----------------------------
...
descrip   = 'Emissions of non-acetone ketones, including 2-butanone (C4H8O), pentanones(C5H10O), heptanones(C7H12O), and octanones (C8H16O), expressed as acetone flux '
...
for yr=0,numyears-1 do begin
  ...
  ems_ofn    = 'accmip_maccity_emissions_anthrop_other_ketones_all_sectors_'+syear+'_0.5x0.5.nc'
  ...
  ncdf_attput,ncid,fieldvar_id,'mol_weight',molw_Me2CO

  ncdf_attput,ncid,/global,'source',source
  ncdf_attput,ncid,/global,'history',history
  ncdf_attput,ncid,/global,'description',descrip
