...
file = 'MACCity_anthro_propane_1960-2020_98257.nc'
...
openw, unit1, workspace+'MACCity_anthrop_C3H8_monthly.csv', /get_lun
openw, unit2, workspace+'MACCity_anthrop_C3H8_annual.csv', /get_lun
...
for yr=0,numyears-1 do begin
  ...
  ems_ofn    = 'accmip_maccity_emissions_anthrop_C3H8_all_sectors_'+syear+'_0.5x0.5.nc'
