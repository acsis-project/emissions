...
file = 'MACCity_anthro_NOx_1960-2020_14412.nc'
...
openw, unit1, workspace+'MACCity_anthrop_NOx_monthly.csv', /get_lun
openw, unit2, workspace+'MACCity_anthrop_NOx_annual.csv', /get_lun
