...
;
;
;   combine_all_sources_butanes_1960-2020.pro
;
;
...
anthrop_file = ukca_gws+'emissions/ACCMIP_interpolated_1850-2100/Butanes/anthrop_1960-2020_historic_RCP85/newfile.nc'
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/Butanes/historic/newfile.nc'

; output file:

ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_butanes_1960-2020_360d.nc'
;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_butanes_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/butanes_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/butanes_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface C4H10 emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',58.12,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_butanes_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of butanes (combined n-butane and isobutane) from 1960 to 2020.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','10.544 Tg C4H10 per year'
