...
;
;
;   combine_all_sources_MeCHO_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for acetaldehyde from
;
...
biogen_file  = ukca_gws+'emissions/MEGAN-MACC_1980-2010/MEGAN-MACC_biogenic_MeCHO_processed.nc'

; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_MeCHO_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_MeCHO_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/MeCHO_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/MeCHO_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'history','combine_all_sources_MeCHO_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of acetaldehyde from 1960 to 2020.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','22.546 Tg MeCHO per year'
