...
file1 = 'CO-em-anthro_input4MIPs_emissions_CMIP_CEDS-v2016-07-26-sectorDim_gr_195001-199912.nc'
file2 = 'CO-em-anthro_input4MIPs_emissions_CMIP_CEDS-v2016-07-26-sectorDim_gr_200001-201412.nc'

numyears = 50
startyear = 1950

sectors = 8
varstring = 'CO_em_anthro'
...
openw, unit1, workspace+'/CMIP6_anthrop_CO_monthly.csv', /get_lun
openw, unit2, workspace+'/CMIP6_anthrop_CO_annual.csv', /get_lun
...
; ems_ofn    = 'accmip_maccity_emissions_anthrop_CO_all_sectors_'+syear+'_0.5x0.5.nc'
