...
;
;
;   combine_all_sources_DMS_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for DMS from
;
...
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/DMS/historic/newfile.nc'

; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_DMS_biomass_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_DMS_biomass_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/DMS_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/DMS_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface DMS emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',62.13,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_DMS_biomass_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of dimethyl sulfide (DMS, C2H6S) from 1960 to 2020.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','0.141 Tg DMS per year'
