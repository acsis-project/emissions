...
anthrop_file = ukca_gws+'emissions/CMIP6/anthrop/CMIP6_CEDS+RCP85_anthropogenic_ethyne_1960-2020.nc'
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/ethyne/historic/newfile.nc'

; output file:

ofn          = ukca_gws+'emissions/CMIP6/0.5x0.5_combined_hybrid/CMIP6_hybrid_combined_ethyne_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/CMIP6/CMIP6_hybrid_ethyne_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/CMIP6/CMIP6_hybrid_ethyne_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_hybrid_combined_ethyne_1960-2020.pro v1.0'
