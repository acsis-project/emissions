...
;
;
;   CMIP6_hybrid_combined_ethyne_1960-2020.pro
;
;
...
anthrop_file = ukca_gws+'emissions/CMIP6/anthrop/v2/CMIP6_CEDS_anthropogenic_ethyne_1960-2020_v2.nc'
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/ethyne/historic/newfile.nc'

; output file:

ofn          = ukca_gws+'emissions/CMIP6/0.5x0.5_combined_hybrid/CMIP6_hybrid_combined_ethyne_1960-2020_greg_v2.nc'
...
openw, unit1, ukca_gws+'emissions/CMIP6/CMIP6_hybrid_ethyne_monthly_combined_v2.csv', /get_lun
openw, unit2, ukca_gws+'emissions/CMIP6/CMIP6_hybrid_ethyne_annual_combined_v2.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_hybrid_combined_ethyne_1960-2020.pro v2.0'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','4.43 Tg C2H2 per year'
