...
;
;
;   CEDS_NOx_anthrop_1960-2020.pro
;
;
;   This program reads monthly surface emission fluxes of NOx from all anthropogenic 
;   sectors (i.e. not from aviation). These emissions were generated by CEDS
;   for use in CMIP6.
;
;   Three raw rources data files are used:
;
;   * NOx-em-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18_gn_195001-199912.nc
;   * NOx-em-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18_gn_200001-201412.nc
;   * accmip_maccity_emissions_anthrop_NOx_all_sectors_2015-2020_0.5x0.5.nc
;
...
;   Date:     Wed Feb 28 09:12:27 GMT 2018
;   version:  1.0
;
;
;-----------------------------------------------------------------------------
...
cedsfile1 = 'NOx-em-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18_gn_195001-199912.nc'
cedsfile2 = 'NOx-em-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18_gn_200001-201412.nc'
gapfile   = 'accmip_maccity_emissions_anthrop_NOx_all_sectors_2015-2020_0.5x0.5.nc'

cedsvarname = 'NOx_em_anthro'  ; (time, sector, lat, lon)
gapvarname  = 'emiss_flux'  ; (time, lat, lon)

ofname    = 'CMIP6_CEDS+RCP85_anthropogenic_NOx_1960-2020.nc'
...
; rescale mass fluxes from kg(NO2) m-2 s-1 to kg(NO) m-2 s-1

molw_NO  = 30.01  ; g mol-1
molw_NO2 = 46.01  ; g mol-1

field = field * (molw_NO/molw_NO2)
...
;------ read MACCity anthropogenic data file ----------------------------------
...
ncdf_varget,ncid,timeid,times3  ; in days since 1960-01-01 00:00:00
print,'Number of time steps in file: ',n_elements(times3)
ncdf_varget,ncid,lonid,lons
ncdf_varget,ncid,latid,glats
...
; swap order of latitudes from descending N-->S to ascending S-->N
print,'swapping field to ascending lats...'
tmpfield = dblarr(n_elements(lons),n_elements(glats),n_elements(times3))

for t=0,n_elements(times3)-1 do begin
for k=0,n_elements(glats)-1 do begin
   k_bar = (n_elements(glats)-1)-k   ; k counting up from 0, k_bar counting down from 359
   tmpfield[*,k_bar,t] = gfield[*,k,t]
endfor
endfor
...
openw, unit1, workspace+'CEDS+RCP85_NOx_as_NO_anthrop_annual.csv', /get_lun
openw, unit2, workspace+'CEDS+RCP85_NOx_as_NO_anthrop_monthly.csv', /get_lun
...
source    = 'CEDS-2017-05-18-supplemental-data and ACCMIP-MACCity RCP8.5'
...
ncdf_attput,ncid,fieldvar_id,'description','NOx expressed as NO'

ncdf_attput,ncid,/global,'source',source
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CEDS_NOx_anthrop_1960-2020.pro v1.0'
