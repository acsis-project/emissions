...
;   for use in CMIP6.
;
;   Two raw rources data files are used:
;
...
;   Date:     Thu Apr 12 11:13:31 BST 2018
;   version:  2.0
;
;
;-----------------------------------------------------------------------------
...
ofname    = 'CMIP6_CEDS_anthropogenic_NOx_1960-2020_v2.nc'
...
;------ assign 12-monthly fluxes of 2014 to the remainder of the time series --


print,'assigning data to array...'
count = 0  ; from 0 to 71 -- loop over months from 01-2015 to 12-2020

for y = 0,5 do begin  
  for m = 0,11 do begin  

     emsfield[*,*,count+660] = newfield[*,*,0,168+m] + newfield[*,*,1,168+m] $
                             + newfield[*,*,2,168+m] + newfield[*,*,3,168+m] $
                             + newfield[*,*,4,168+m] + newfield[*,*,5,168+m] $
                             + newfield[*,*,6,168+m] + newfield[*,*,7,168+m]
     count = count+1
...
openw, unit1, workspace+'CEDS_NOx_as_NO_anthrop_annual.csv', /get_lun
openw, unit2, workspace+'CEDS_NOx_as_NO_anthrop_monthly.csv', /get_lun
...
source    = 'CEDS-2017-05-18-supplemental-data'
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CEDS_NOx_anthrop_1960-2020.pro v2.0'
