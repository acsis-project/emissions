...
;
;
;   CMIP6_hybrid_combined_C3H8_lumped_1960-2020.pro
;
;
...
file1 = ukca_gws+'emissions/CMIP6/0.5x0.5_combined_hybrid/CMIP6_hybrid_combined_C3H8_1960-2020_greg.nc'
file2 = ukca_gws+'emissions/CMIP6/0.5x0.5_combined_hybrid/CMIP6_hybrid_combined_propene_1960-2020_greg.nc'

; output file:

ofn = ukca_gws+'emissions/CMIP6/0.5x0.5_combined_hybrid/CMIP6_hybrid_combined_C3H8_lumped_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/CMIP6/CMIP6_hybrid_C3H8_lumped_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/CMIP6/CMIP6_hybrid_C3H8_lumped_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_hybrid_combined_C3H8_lumped_1960-2020.pro v1.0'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','31.68 Tg C3H8 (lumped) per year'
