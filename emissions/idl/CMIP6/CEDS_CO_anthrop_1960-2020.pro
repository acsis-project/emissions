...
;   Date:     Thu Apr 12 10:01:53 BST 2018
;   version:  2.0
;
;
;-----------------------------------------------------------------------------
...
ofname    = 'CMIP6_CEDS_anthropogenic_CO_1960-2020_v2.nc'
...
openw, unit1, workspace+'CEDS_CO_anthrop_annual.csv', /get_lun
openw, unit2, workspace+'CEDS_CO_anthrop_monthly.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CEDS_CO_anthrop_1960-2020.pro v2.0'
