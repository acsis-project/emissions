...
;
;
;   CEDS_CO_anthrop_1960-2020.pro
;
;
;   This program reads monthly surface emission fluxes of CO from all anthropogenic 
;   sectors (i.e. not from aviation). These emissions were generated by CEDS
;   for use in CMIP6.
;
;   Three raw rources data files are used:
;
;   * CO-em-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18_gn_195001-199912.nc
;   * CO-em-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18_gn_200001-201412.nc
;   * accmip_maccity_emissions_anthrop_CO_all_sectors_2015-2020_0.5x0.5.nc
;
...
;   Date:     Fri Mar  2 11:02:00 GMT 2018
;   version:  1.0
;
;
;-----------------------------------------------------------------------------
...
cedsfile1 = 'CO-em-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18_gn_195001-199912.nc'
cedsfile2 = 'CO-em-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18_gn_200001-201412.nc'
gapfile   = 'accmip_maccity_emissions_anthrop_CO_all_sectors_2015-2020_0.5x0.5.nc'

cedsvarname = 'CO_em_anthro'  ; (time, sector, lat, lon)
gapvarname  = 'emiss_flux'  ; (time, lat, lon)

ofname    = 'CMIP6_CEDS+RCP85_anthropogenic_CO_1960-2020.nc'
...
openw, unit1, workspace+'CEDS+RCP85_CO_anthrop_annual.csv', /get_lun
openw, unit2, workspace+'CEDS+RCP85_CO_anthrop_monthly.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CEDS_CO_anthrop_1960-2020.pro v1.0'
