...
;
;
;   CMIP6_hybrid_combined_C2H6_lumped_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for ethane, ethene and 
;   ethyne from all sectors and combines all the data into one netCDF file using
...
file1 = ukca_gws+'emissions/CMIP6/0.5x0.5_combined_hybrid/CMIP6_hybrid_combined_C2H6_1960-2020_greg.nc'
file2 = ukca_gws+'emissions/CMIP6/0.5x0.5_combined_hybrid/CMIP6_hybrid_combined_ethene_1960-2020_greg.nc'
file3 = ukca_gws+'emissions/CMIP6/0.5x0.5_combined_hybrid/CMIP6_hybrid_combined_ethyne_1960-2020_greg.nc'

; output file:

ofn = ukca_gws+'emissions/CMIP6/0.5x0.5_combined_hybrid/CMIP6_hybrid_combined_C2H6_lumped_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/CMIP6/CMIP6_hybrid_C2H6_lumped_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/CMIP6/CMIP6_hybrid_C2H6_lumped_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_hybrid_combined_C2H6_lumped_1960-2020.pro v1.0'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','56.14 Tg C2H6 (lumped) per year'
