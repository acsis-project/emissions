...
tot_ems_str = strcompress(string(total_emiss*1.e-9,format='(f6.2)'),/remove_all)+' Tg C3H8 per year (360d_cal)'
...
ncdf_attput,ncid,fieldvar_id,'long_name','Biogenic surface emissions of lumped propane and propene (propylene), expressed as propane'
ncdf_attput,ncid,fieldvar_id,'standard_name','tendency_of_atmosphere_mass_content_of_propane_due_to_emission'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',44.10,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'title','Monthly surface emissions of lumped propane and propene (propylene), expressed as propane, calculated using an arithmetic mean of monthly emission fluxes for the years 2001-2010'
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_biogenic_C3H8_clim_2001-2010.pro v1.2'
