...
file    = 'POET_oceanic_CO_1990_84299.nc'     ; raw data input file
ems_ofn = 'POET_oceanic_CO_1990_processed.nc' ; output file with processed data
...
openw, unit1, workspace+'/POET_oceanic_CO_monthly.csv', /get_lun
openw, unit2, workspace+'/POET_oceanic_CO_annual.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_POET_oceanic_CO.pro v1.0'
