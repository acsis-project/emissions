...
;
;
;   CMIP6_biogenic_Me2CO_MAM_2001-2010.pro
;
;
...
ifn1 = 'MEGAN-MACC_biogenic_acetone_1980-2010_86117.nc'
ifn2 = 'MEGAN-MACC_biogenic_other_ketones_1980-2010_4510.nc'

ofn = 'MEGAN-MACC_biogenic_Me2CO_MAM_2001-2010.nc'
...
print,'reading emissions data 1: '
print, ifn1

ncid = ncdf_open(workspace+ifn1,/nowrite)
...
ncdf_varget,ncid,varid,biogflux1
ncdf_close,ncid

print,'file closed.'


print,'reading emissions data 2: '
print, ifn2

ncid = ncdf_open(workspace+ifn2,/nowrite)

varid  = ncdf_varid(ncid,'MEGAN_MACC')
ncdf_attget,ncid,varid,'units',varunits
ncdf_varget,ncid,varid,biogflux2
ncdf_close,ncid

print,'file closed.'


;--- convert other ketones flux to acetone flux

biogflux2 = biogflux2 * scale


;---- lump emissions fluxes

biogflux = dblarr(n_elements(lons),n_elements(lats),n_elements(times))

print,'lumping emissions fluxes'

biogflux = biogflux1 + biogflux2
...
tot_ems_str = strcompress(string(total_emiss*1.e-9,format='(f6.2)'),/remove_all)+' Tg Me2CO per year (360d_cal)'
...
ncdf_attput,ncid,fieldvar_id,'long_name','Biogenic surface emissions of lumped acetone and other ketones, expressed as acetone (C3H6O)'
ncdf_attput,ncid,fieldvar_id,'standard_name','tendency_of_atmosphere_mass_content_of_acetone_due_to_emission'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',58.08,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'title','Monthly surface emissions of lumped acetone and other ketones, expressed as acetone (C3H6O), calculated using an arithmetic mean of monthly emission fluxes for the years 2001-2010'
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_biogenic_Me2CO_MAM_2001-2010.pro v1.0'
