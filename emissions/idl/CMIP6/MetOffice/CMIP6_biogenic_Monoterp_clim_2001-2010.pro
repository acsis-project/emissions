...
;
;
;   CMIP6_biogenic_Monoterp_clim_2001-2010.pro
;
;
...
ofn = 'MEGAN-MACC_biogenic_Monoterp_clim_2001-2010.nc'
...
tot_ems_str = strcompress(string(total_emiss*1.e-9,format='(f6.2)'),/remove_all)+' Tg Monoterpenes per year (360d_cal)'
...
ncdf_attput,ncid,fieldvar_id,'standard_name','tendency_of_atmosphere_mass_content_of_monoterpenes_due_to_emission'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',136.24,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'title','Monthly surface emissions of monoterpene, calculated using an arithmetic mean of monthly emission fluxes for the years 2001-2010'
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_biogenic_Monoterp_clim_2001-2010.pro v1.1'
