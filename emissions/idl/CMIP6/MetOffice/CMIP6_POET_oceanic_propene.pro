...
;
;
;   CMIP6_POET_oceanic_propene.pro
;
;
...
workspace = '/home/users/mkoehler/ukca_gws/emissions/POET_1990/'

file    = 'POET_oceanic_propene_1990_15101.nc'     ; raw data input file
ems_ofn = 'POET_oceanic_propene_1990_processed.nc' ; output file with processed data
...
openw, unit1, workspace+'/POET_oceanic_propene_monthly.csv', /get_lun
openw, unit2, workspace+'/POET_oceanic_propene_annual.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_POET_oceanic_propene.pro v1.0'
