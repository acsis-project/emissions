...
;
;
;   CMIP6_biogenic_CO_clim_2001-2010.pro
;
;
...
ofn = 'MEGAN-MACC_biogenic_CO_clim_2001-2010.nc'
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_biogenic_CO_clim_2001-2010.pro v1.1'
