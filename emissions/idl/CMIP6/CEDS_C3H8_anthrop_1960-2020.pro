...
;
;
;   CEDS_C3H8_anthrop_1960-2020.pro
;
;
;   This program reads monthly surface emission fluxes of propane from all anthropogenic 
;   sectors. These emissions were generated by CEDS for use in CMIP6.
;
;   Three raw rources data files are used:
;
;   * VOC03-propane-em-speciated-VOC-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18
;       -supplemental-data_gn_195001-199912.nc
;   * VOC03-propane-em-speciated-VOC-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18
;       -supplemental-data_gn_200001-201412.nc
;   * accmip_maccity_emissions_anthrop_C3H8_all_sectors_2015-2020_0.5x0.5.nc
;
...
;   Date:     Mon Mar  5 13:29:47 GMT 2018
;   version:  1.0
;
;
;-----------------------------------------------------------------------------
...
cedsfile1 = 'VOC03-propane-em-speciated-VOC-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18-supplemental-data_gn_195001-199912.nc'
cedsfile2 = 'VOC03-propane-em-speciated-VOC-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18-supplemental-data_gn_200001-201412.nc'
gapfile   = 'accmip_maccity_emissions_anthrop_C3H8_all_sectors_2015-2020_0.5x0.5.nc'

cedsvarname = 'VOC03_propane_em_speciated_VOC_anthro'  ; (time, sector, lat, lon)
gapvarname  = 'emiss_flux'  ; (time, lat, lon)

ofname    = 'CMIP6_CEDS+RCP85_anthropogenic_C3H8_1960-2020.nc'
...
openw, unit1, workspace+'CEDS+RCP85_C3H8_anthrop_annual.csv', /get_lun
openw, unit2, workspace+'CEDS+RCP85_C3H8_anthrop_monthly.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CEDS_C3H8_anthrop_1960-2020.pro v1.0'
