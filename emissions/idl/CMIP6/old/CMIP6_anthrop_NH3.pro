...
file1 = 'NH3-em-anthro_input4MIPs_emissions_CMIP_CEDS-v2016-07-26-sectorDim_gr_195001-199912.nc'
file2 = 'NH3-em-anthro_input4MIPs_emissions_CMIP_CEDS-v2016-07-26-sectorDim_gr_200001-201412.nc'

numyears = 15
startyear = 2000

sectors = 8
varstring = 'NH3_em_anthro'
...
openw, unit1, workspace+'/CMIP6_anthrop_NH3_monthly.csv', /get_lun
openw, unit2, workspace+'/CMIP6_anthrop_NH3_annual.csv', /get_lun
...
; ems_ofn    = 'accmip_maccity_emissions_anthrop_NH3_all_sectors_'+syear+'_0.5x0.5.nc'
