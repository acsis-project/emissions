...
;
;
;   CMIP6_hybrid_combined_ethene_1960-2020.pro
;
;
...
anthrop_file = ukca_gws+'emissions/CMIP6/anthrop/CMIP6_CEDS+RCP85_anthropogenic_ethene_1960-2020.nc'
...
ofn          = ukca_gws+'emissions/CMIP6/0.5x0.5_combined_hybrid/CMIP6_hybrid_combined_ethene_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/CMIP6/CMIP6_hybrid_ethene_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/CMIP6/CMIP6_hybrid_ethene_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_hybrid_combined_ethene_1960-2020.pro v1.0'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','39.19 Tg C2H4 per year'
