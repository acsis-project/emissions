...
;
;
;   CEDS_ethyne_anthrop_1960-2020.pro
;
;
;   This program reads monthly surface emission fluxes of ethyne from all anthropogenic 
;   sectors. These emissions were generated by CEDS for use in CMIP6.
;
;   Two raw rources data files are used:
;
;   * VOC09-ethyne-em-speciated-VOC-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18
...
;   Date:     Mon Apr 16 15:25:13 BST 2018
;   version:  2.0
;
;
;-----------------------------------------------------------------------------
...
cedsfile1 = 'VOC09-ethyne-em-speciated-VOC-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18-supplemental-data_gn_195001-199912.nc'
cedsfile2 = 'VOC09-ethyne-em-speciated-VOC-anthro_input4MIPs_emissions_CMIP_CEDS-2017-05-18-supplemental-data_gn_200001-201412.nc'

cedsvarname = 'VOC09_ethyne_em_speciated_VOC_anthro'  ; (time, sector, lat, lon)

ofname    = 'CMIP6_CEDS_anthropogenic_ethyne_1960-2020_v2.nc'
...
openw, unit1, workspace+'CEDS_ethyne_anthrop_annual.csv', /get_lun
openw, unit2, workspace+'CEDS_ethyne_anthrop_monthly.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CEDS_ethyne_anthrop_1960-2020.pro v2.0'
