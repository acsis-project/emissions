...
;   * accmip_interpolated_emissions_RCP85_ethyne_all_sectors_2015-2020_0.5x0.5.nc
;
...
;   Date:     Mon Mar  5 15:54:21 GMT 2018
;   version:  1.0
;
;
;-----------------------------------------------------------------------------
...
gapfile   = 'accmip_interpolated_emissions_RCP85_ethyne_all_sectors_2015-2020_0.5x0.5.nc'

cedsvarname = 'VOC09_ethyne_em_speciated_VOC_anthro'  ; (time, sector, lat, lon)
gapvarname  = 'emiss_flux'  ; (time, lat, lon)

ofname    = 'CMIP6_CEDS+RCP85_anthropogenic_ethyne_1960-2020.nc'
...
openw, unit1, workspace+'CEDS+RCP85_ethyne_anthrop_annual.csv', /get_lun
openw, unit2, workspace+'CEDS+RCP85_ethyne_anthrop_monthly.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CEDS_ethyne_anthrop_1960-2020.pro v1.0'
