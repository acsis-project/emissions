...
;
;
;   CMIP6_hybrid_combined_propene_1960-2020.pro
;
;
...
anthrop_file = ukca_gws+'emissions/CMIP6/anthrop/CMIP6_CEDS+RCP85_anthropogenic_propene_1960-2020.nc'
...
ofn          = ukca_gws+'emissions/CMIP6/0.5x0.5_combined_hybrid/CMIP6_hybrid_combined_propene_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/CMIP6/CMIP6_hybrid_propene_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/CMIP6/CMIP6_hybrid_propene_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_hybrid_combined_propene_1960-2020.pro v1.0'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','22.28 Tg C3H6 per year'
