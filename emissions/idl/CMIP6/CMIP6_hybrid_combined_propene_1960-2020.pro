...
anthrop_file = ukca_gws+'emissions/CMIP6/anthrop/v2/CMIP6_CEDS_anthropogenic_propene_1960-2020_v2.nc'
...
ofn          = ukca_gws+'emissions/CMIP6/0.5x0.5_combined_hybrid/CMIP6_hybrid_combined_propene_1960-2020_greg_v2.nc'
...
openw, unit1, ukca_gws+'emissions/CMIP6/CMIP6_hybrid_propene_monthly_combined_v2.csv', /get_lun
openw, unit2, ukca_gws+'emissions/CMIP6/CMIP6_hybrid_propene_annual_combined_v2.csv', /get_lun
...
ncdf_attput,ncid,/global,'history',systime(/utc)+' UTC: CMIP6_hybrid_combined_propene_1960-2020.pro v2.0'
