...
;
;
;   combine_all_sources_pentanes_1960-2020.pro
;
;
...
;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_pentanes_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_pentanes_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/pentanes_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/pentanes_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface C5H12 emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',75.15,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_pentanes_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of pentanes from 1960 to 2020.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','14.612 Tg C5H12 per year'
