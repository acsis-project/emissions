...
;
;
;   MEGAN-MACC_biogenic_propene_preprocess.pro
;
;
...
ifn = 'MEGAN-MACC_biogenic_propene_1980-2010_758.nc'

ofn = 'MEGAN-MACC_biogenic_propene_processed.nc'
...
openw, unit1, workspace+'/MEGAN-MACC_biogenic_propene_monthly.csv', /get_lun
openw, unit2, workspace+'/MEGAN-MACC_biogenic_propene_annual.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Biogenic surface propene (propylene, C3H8) emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',42.08,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','MEGAN-MACC_biogenic_propene_preprocess.pro'
