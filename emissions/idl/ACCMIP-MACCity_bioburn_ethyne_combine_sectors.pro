...
openw, unit, workspace+'MACCity_ethyne_bioburn.csv', /get_lun
...
for yr=0,n_elements(year)-1 do begin
  ...
  ems_file1  = 'accmip_maccity_emissions_'+scenario+'_ethyne_biomassburning_'+syear+'_0.5x0.5.nc'
;  ems_file2  = 'accmip_interpolated_emissions_'+scenario+'_ethyne_biomassburning_'+syear+'_0.5x0.5.nc'
;  ems_file3  = 'accmip_interpolated_emissions_'+scenario+'_ethyne_ships_'+syear+'_0.5x0.5.nc'

  ems_ofn    = 'accmip_maccity_emissions_'+scenario+'_ethyne_all_sectors_'+syear+'_0.5x0.5.nc'
