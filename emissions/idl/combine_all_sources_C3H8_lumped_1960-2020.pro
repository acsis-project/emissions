...
;
;
;   combine_all_sources_C3H8_lumped_1960-2020.pro
;
;
...
file1 = ukca_gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_C3H8_1960-2020_greg.nc'
file2 = ukca_gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_propene_1960-2020_greg.nc'
;file1 = ukca_gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_C3H8_1960-2020_360d.nc'
;file2 = ukca_gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_propene_1960-2020_360d.nc'

; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_C3H8_lumped_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_C3H8_lumped_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/C3H8_lumped_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/C3H8_lumped_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'lumping','Lumped emissions of C3H8 and C3H6, expressed as C3H8'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',44.10,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_C3H8_lumped_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of propane, lumped with propene, from 1960 to 2020.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','30.0 Tg C3H8 per year'
