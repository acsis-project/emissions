...
;
;
;   MEGAN-MACC_biogenic_C5H8_preprocess.pro
;
;
...
ofn = 'MEGAN-MACC_biogenic_C5H8_processed.nc'
...
openw, unit1, workspace+'/MEGAN-MACC_biogenic_C5H8_monthly.csv', /get_lun
openw, unit2, workspace+'/MEGAN-MACC_biogenic_C5H8_annual.csv', /get_lun
...
ncdf_attput,ncid,/global,'history','MEGAN-MACC_biogenic_C5H8_preprocess.pro'
