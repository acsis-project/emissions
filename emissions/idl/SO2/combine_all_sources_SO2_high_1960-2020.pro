...
;
;
;   combine_all_sources_SO2_high_1960-2020.pro
;
;
...
file1  = ukca_gws + maccity_dir + 'MACCity_anthro_SO2_energy_production_and_distribution_1960-2020_85779.nc'
file2  = ukca_gws + maccity_dir + 'MACCity_anthro_SO2_industrial_processes_and_combustion_1960-2020_86699.nc'


; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_SO2_high_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_SO2_high_1960-2020_greg.nc'
...
print,'File1: Energy production and distribution'
...
print,'File2: Industrial processes and combustion'
...
allflux = file1_flux + (0.5 * file2_flux)
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/SO2_high_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/SO2_high_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'history','combine_all_sources_SO2_high_1960-2020.pro'
...
ncdf_attput,ncid,/global,'source','MACCity provides anthropogenic emissions from 1960 to 2020. The emissions flux in this file comprises lumped SO2 emissions from the following anthropogenic sectors: (1) Energy production and distribution and (2) 50% of industrial processes and combustion.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','66.572 Tg SO2 per year'
