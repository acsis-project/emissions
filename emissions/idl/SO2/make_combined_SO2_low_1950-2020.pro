...
;
;
;   make_combined_SO2_low_1950-2020.pro
;
;
...
; input file:
ifn   = gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_SO2_low_1960-2020_greg.nc'
; output file:
ofn   = gws+'emissions/combined_1950-2020/combined_sources_SO2_low_1950-2020.nc'
...
ncdf_attput,ncid,/global,'history','make_combined_SO2_low_1950-2020.pro'
