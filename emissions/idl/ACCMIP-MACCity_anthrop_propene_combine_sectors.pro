...
file = 'MACCity_anthro_propene_1960-2020_98295.nc'
...
openw, unit1, workspace+'MACCity_anthrop_propene_monthly.csv', /get_lun
openw, unit2, workspace+'MACCity_anthrop_propene_annual.csv', /get_lun
...
for yr=0,numyears-1 do begin
  ...
  ems_ofn    = 'accmip_maccity_emissions_anthrop_propene_all_sectors_'+syear+'_0.5x0.5.nc'
