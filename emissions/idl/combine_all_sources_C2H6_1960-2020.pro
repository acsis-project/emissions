...
;
;
;   combine_all_sources_C2H6_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for ethane from
;
...
anthrop_file = ukca_gws+'emissions/ACCMIP-MACCity_anthrop_1960-2020/C2H6/newfile.nc'
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/C2H6/historic/newfile.nc'
biogen_file  = ukca_gws+'emissions/MEGAN-MACC_1980-2010/MEGAN-MACC_biogenic_C2H6_processed.nc'
oceanic_file = ukca_gws+'emissions/POET_1990/POET_oceanic_C2H6_1990_processed.nc'

; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_C2H6_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_C2H6_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/C2H6_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/C2H6_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,/global,'history','combine_all_sources_C2H6_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of ethane from 1960 to 2020.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','6.918 Tg C2H6 per year'
