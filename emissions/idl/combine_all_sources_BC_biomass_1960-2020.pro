...
;
;
;   combine_all_sources_BC_biomass_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for Black Carbon (BC) from
;
...
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/BC/historic/newfile.nc'

; output file:

ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_BC_biomass_1960-2020_360d.nc'
;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_BC_biomass_1960-2020_greg.nc'
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/BC_biomass_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/BC_biomass_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface BC emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',12.011,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_BC_biomass_1960-2020.pro'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','2.194 Tg C per year'
