...
;
;
;   MEGAN-MACC_biogenic_monoterp_preprocess.pro
;
;
...
workspace = '/group_workspaces/jasmin2/ukca/vol1/mkoehler/emissions/MEGAN-MACC_1980-2010/'
ifn = 'MEGAN-MACC_biogenic_monoterpenes_1980-2010_79169.nc'

ofn = 'MEGAN-MACC_biogenic_monoterp_processed.nc'
...
openw, unit1, workspace+'/MEGAN-MACC_biogenic_monoterp_monthly.csv', /get_lun
openw, unit2, workspace+'/MEGAN-MACC_biogenic_monoterp_annual.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Biogenic surface monoterpene (C10H16) emissions'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',136.24,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','MEGAN-MACC_biogenic_monoterp_preprocess.pro'
