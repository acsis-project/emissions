...
;
;
;   combine_all_sources_OC_biofuel_1960-2020.pro
;
;
;   This program reads emissions files for Black Carbon (OC) from 
...
file1  = ukca_gws + maccity_dir + 'MACCity_anthro_OC_residential_and_commercial_combustion_1960-2020_12444.nc'
file2  = ukca_gws + maccity_dir + 'MACCity_anthro_OC_agricultural_waste_burning_1960-2020_16232.nc'
file3  = ukca_gws + maccity_dir + 'MACCity_anthro_OC_waste_treatment_and_disposal_1960-2020_12321.nc'


; output file:

ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_OC_biofuel_1960-2020_360d.nc'
;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_OC_biofuel_1960-2020_greg.nc'
...
print,'File1: Residential and commercial combustion'
...
print,'File3: Waste treatment and disposal'
...
allflux = file1_flux + file2_flux + file3_flux

;File1: Residential and commercial combustion
;File2: Agricultural waste burning
;File3: Waste treatment and disposal
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/OC_biofuel_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/OC_biofuel_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface OC biofuel emissions expressed as carbon'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',12.011,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_OC_biofuel_1960-2020.pro'
...
ncdf_attput,ncid,/global,'source','MACCity provides anthropogenic emissions from 1960 to 2020. The emissions flux in this file comprises lumped OC emissions from the following anthropogenic sectors: (1) Residential and commercial combustion, (2) agricultural waste burning, and (3) waste treatment and disposal.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','8.509 Tg C per year'
