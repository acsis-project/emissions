...
;
;
;   combine_all_sources_OC_biomass_1960-2020.pro
;
;
;   This program reads pre-processed emissions files for Organic Carbon (OC) from
;
...
bioburn_file = ukca_gws+'emissions/ACCMIP-MACCity_bioburn_1960-2008/OC/historic/newfile.nc'

; output file:

ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_OC_biomass_1960-2020_360d.nc'
;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_OC_biomass_1960-2020_greg.nc'
...
if (gregorian ne 1) then begin
  ...
  for year=0,numyears-1 do begin
     ...
     for mth=0,n_elements(numdays)-1 do begin
       ...
       bioburn_flux[*,*,time-1] = bioburn_flux[*,*,time-1] * ( double(month_length)/double(30) )
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/OC_biomass_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/OC_biomass_annual_combined.csv', /get_lun
...
for year=0,numyears-1 do begin
  ...
  for mth=0,n_elements(numdays)-1 do begin
    ...
    time = time+1
    outfield[*,*,mth] = bioburn_flux[*,*,time-1]
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface OC emissions expressed as carbon'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',12.011,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_OC_biomass_1960-2020.pro'
...
ncdf_attput,ncid,/global,'source','The emissions flux in this file originates only from biomass burning sources. MACCity provides biomass burning emissions from 1960 to 2008. Biomass burning emissions from 2009 to 2020 have been taken from the ACCMIP linearly interpolated RCP8.5 data set.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','18.448 Tg C per year'
...
ncdf_varput,ncid,fieldvar_id,bioburn_flux
