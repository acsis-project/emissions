...
;
;
;   make_combined_OC_biofuel_1950-2020.pro
;
;
...
; input file:
ifn   = gws+'emissions/combined_1960-2020/0.5x0.5/combined_sources_OC_biofuel_1960-2020_greg.nc'
; output file:
ofn   = gws+'emissions/combined_1950-2020/combined_sources_OC_biofuel_1950-2020.nc'
...
ncdf_attput,ncid,/global,'history','make_combined_OC_biofuel_1950-2020.pro'
...
ncdf_attput,ncid,/global,'source','MACCity provides anthropogenic emissions from 1960 to 2020. The emissions flux in this file comprises lumped OC emissions from the following anthropogenic sectors: (1) Residential and commercial combustion, (2) agricultural waste burning, and (3) waste treatment and disposal. Emissions from 1950-1959 are perpetual 12-monthly emissions of the year 1960.'
