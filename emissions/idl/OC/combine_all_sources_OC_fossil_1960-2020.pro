...
;
;
;   combine_all_sources_OC_fossil_1960-2020.pro
;
;
;   This program reads emissions files for Organic Carbon (OC) from 
;   the following anthropogenic MACCity emissions sectors:
;
...
maccity_dir  = 'emissions/ACCMIP-MACCity_anthrop_1960-2020/sectors/OC/'

file1  = ukca_gws + maccity_dir + 'MACCity_anthro_OC_agricultural_production_1960-2020_16307.nc'
file2  = ukca_gws + maccity_dir + 'MACCity_anthro_OC_maritime_transport_1960-2020_16956.nc'
file3  = ukca_gws + maccity_dir + 'MACCity_anthro_OC_solvent_production_and_use_1960-2020_11608.nc'
file4  = ukca_gws + maccity_dir + 'MACCity_anthro_OC_energy_production_and_distribution_1960-2020_9781.nc'
file5  = ukca_gws + maccity_dir + 'MACCity_anthro_OC_land_transport_1960-2020_9132.nc'
file6  = ukca_gws + maccity_dir + 'MACCity_anthro_OC_industrial_processes_and_combustion_1960-2020_12400.nc'


; output file:

;ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_OC_fossil_1960-2020_360d.nc'
ofn          = ukca_gws+'emissions/combined_1960-2020/combined_sources_OC_fossil_1960-2020_greg.nc'
...
allflux = file1_flux + file2_flux + file3_flux + file4_flux + file5_flux + file6_flux

;File1: Agricultural production
;File2: Maritime transport
;File3: Solvent production and use
;File4: Energy distribution
;File5: Land transportation
;File6: Industry and combustion
...
openw, unit1, ukca_gws+'emissions/combined_1960-2020/OC_fossil_monthly_combined.csv', /get_lun
openw, unit2, ukca_gws+'emissions/combined_1960-2020/OC_fossil_annual_combined.csv', /get_lun
...
ncdf_attput,ncid,fieldvar_id,'long_name','Surface OC fossil fuel emissions expressed as carbon'
ncdf_attput,ncid,fieldvar_id,'molecular_weight',12.011,/float
ncdf_attput,ncid,fieldvar_id,'molecular_weight_units','g mol-1'

ncdf_attput,ncid,/global,'history','combine_all_sources_OC_fossil_1960-2020.pro'
ncdf_attput,ncid,/global,'file_creation_date',systime(/utc)+' UTC'
ncdf_attput,ncid,/global,'description','Time-varying monthly surface emissions of Organic Carbon (OC) from 1960 to 2020.'
ncdf_attput,ncid,/global,'source','MACCity provides anthropogenic emissions from 1960 to 2020. The emissions flux in this file comprises lumped OC emissions from the following anthropogenic sectors: (1) Agricultural production, (2) maritime transport, (3) solvent production and use, (4) energy production and distribution, (5) land transport, and (6) industrial processes and combustion.'
...
ncdf_attput,ncid,/global,'global_total_emissions_2000','4.218 Tg C per year'
