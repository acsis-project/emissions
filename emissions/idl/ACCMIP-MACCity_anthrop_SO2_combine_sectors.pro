...
file = 'MACCity_anthro_SO2_1960-2020_98195.nc'
...
openw, unit1, workspace+'MACCity_anthrop_SO2_monthly.csv', /get_lun
openw, unit2, workspace+'MACCity_anthrop_SO2_annual.csv', /get_lun
