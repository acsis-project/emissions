...
;
;
;   MEGAN-MACC_biogenic_MeOH_preprocess.pro
;
;
...
ofn = 'MEGAN-MACC_biogenic_MeOH_processed.nc'
...
openw, unit1, workspace+'/MEGAN-MACC_biogenic_MeOH_monthly.csv', /get_lun
openw, unit2, workspace+'/MEGAN-MACC_biogenic_MeOH_annual.csv', /get_lun
...
ncdf_attput,ncid,/global,'history','MEGAN-MACC_biogenic_MeOH_preprocess.pro'
