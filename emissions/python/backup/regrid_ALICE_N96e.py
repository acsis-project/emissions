...
ocube.units=iris.unit.Unit('kg m-2 s-1')
...
ocube.coords(axis='t')[0].units=iris.unit.Unit('hours since 1970-01-01', calendar='360_day')
...
frt_dims=iris.coords.AuxCoord(frt,standard_name = 'forecast_reference_time',
                           units=iris.unit.Unit('hours since 1970-01-01', calendar='360_day'))
...
fp_dims=iris.coords.AuxCoord(fp,standard_name = 'forecast_period',
                           units=iris.unit.Unit('hours'),bounds=numpy.array([-720,0],dtype='float64'))
...
#                    emissions_ALICE:um_stash_source = "m01s00i316" ;
