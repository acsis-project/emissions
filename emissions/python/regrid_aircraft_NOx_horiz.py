...
print 'reading grid_file and guessing grid boundaries'
...
print 'reading emissions file data cube'

# This is the original data
ems=iris.load_cube(emissions_file)

print 'intersection part that I dont understand...'
...
ocube.long_name=str.strip(species_name)+' aircraft emissions'
...
ocube.attributes['source']='combined_sources_NOx_1960-2020.nc'
...
outpath='airc_emiss_'+species_name+'.nc'
