...
emissions_file='/group_workspaces/jasmin2/ukca/vol1/mkoehler/emissions/combined_1960-2020/0.5x0.5/combined_sources_C3H8_1960-2020_greg.nc'
#
...
ocube.attributes['lumped_species']='contains only C3H8' # lumping of species
...
ocube.attributes['source']='combined_sources_C3H8_1960-2020.nc'
