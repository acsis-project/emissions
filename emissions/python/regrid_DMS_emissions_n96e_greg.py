...
emissions_file='/group_workspaces/jasmin2/ukca/vol1/mkoehler/emissions/combined_1960-2020/0.5x0.5/combined_sources_DMS_1960-2020_greg.nc'
#
# STASH code emissions are associated with
#  301-320: surface
#  m01s00i059: DMS surface emissions
#
...
ocube.long_name=str.strip(species_name)+' land surf emissions'
...
ocube.attributes['source']='combined_sources_DMS_1960-2020.nc'
